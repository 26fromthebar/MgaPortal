...
export class CollectionsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.dataService.fetchListOptions$.subscribe((data) => {
      // console.log(data);
    ...
    this.dataService.getListData(options).subscribe({
      next: (response) => {
        ...
        this.dataService.setFetchListOptions({
          ...
          pagination: {
            ...this.fetchListOptions.pagination,
  ...
  onPageChange(page: number) {
    const newFetchListOptions: IFetchListOptions = {
      ...this.fetchListOptions,
      pagination: {
        ...this.fetchListOptions.pagination,
        currentPage: page,
    ...
    console.log(newFetchListOptions);

    this.fetchList(newFetchListOptions);
    // this.updateListOptionsAndFetch(newFetchListOptions);
  }
